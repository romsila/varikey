...
namespace engine::backlight
{
    ...
    struct LightChannelControl
    {
        ...
        void set_left(const Color &_color) { set_left(_color.rgb.r, _color.rgb.g, _color.rgb.b); }
        void set_right(const Color &_color) { set_right(_color.rgb.r, _color.rgb.g, _color.rgb.b); }
        void morph_left(const Color &_color) { morph_left(_color.rgb.r, _color.rgb.g, _color.rgb.b); }
        void morph_right(const Color &_color) { morph_right(_color.rgb.r, _color.rgb.g, _color.rgb.b); }

    private:
        SetSmartLedFunc set_smartled_func;
